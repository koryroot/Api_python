# Api de peliculas en python

### Hi world

Este es un proyecto personal hecho con amor y café.

Para correr el proyecto de manera local necesitas :
Tener instalado python ( * en el caso de ubuntu ya viene una versión*)
